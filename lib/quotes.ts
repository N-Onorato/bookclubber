...
export const BOOK_QUOTES: Quote[] = [
  {
  ...
  {
    text: "The reading of all good books is like conversation with the finest (people) of the past centuries.",
    author: "Descartes"
  },
  {
  ...
  {
    text: "We are of opinion that instead of letting books grow moldy behind an iron grating, far from the vulgar gaze, it is better to let them wear out by being read.",
    author: "Jules Verne"
  },
  {
  ...
  {
    text: "It's not that I don't like people. It's just that when I'm in the company of others – even my nearest and dearest – there always comes a moment when I'd rather be reading a book.",
    author: "Maureen Corrigan"
  },
  {
    text: "Books to the ceiling, Books to the sky, My pile of books is a mile high. How I love them! How I need them! I'll have a long beard by the time I read them.",
    author: "Arnold Lobel"
  },
  {
    text: "There is nothing more luxurious than eating while you read—unless it be reading while you eat.",
    author: "E. Nesbit"
  },
  {
  ...
  {
    text: "Man reading should be man intensely alive. The book should be a ball of light in one's hand.",
    author: "Ezra Pound"
  },
  {
    text: "If we encounter a man of rare intellect, we should ask him what books he reads.",
  ...
  {
    text: "Beware of the person of one book.",
  ...
  {
    text: "You may have tangible wealth untold. Caskets of jewels and coffers of gold. Richer than I you can never be — I had a mother who read to me.",
  ...
  {
    text: "Oh, magic hour, when a child first knows she can read printed words!",
    author: "Betty Smith"
  },
  {
  ...
  {
    text: "No entertainment is so cheap as reading, nor any pleasure so lasting.",
  ...
  {
    text: "If you are going to get anywhere in life you have to read a lot of books.",
    author: "Roald Dahl"
  },
  {
    text: "That perfect tranquility of life, which is nowhere to be found but in retreat, a faithful friend and a good library.",
    author: "Aphra Behn"
  },
  {
    text: "To acquire the habit of reading is to construct for yourself a refuge from almost all the miseries of life.",
  ...
  {
    text: "These books gave Matilda a hopeful and comforting message: You are not alone.",
    author: "Roald Dahl"
  },
  {
  ...
  {
    text: "Despite the enormous quantity of books, how few people read! And if one reads profitably, one would realize how much stupid stuff the vulgar herd is content to swallow every day.",
    author: "Voltaire"
  },
  {
  ...
  {
    text: "Libraries will get you through times of no money better than money will get you through times of no libraries.",
    author: "Anne Herbert"
  },
  {
    text: "Ah, how good it is to be among people who are reading.",
  ...
  {
    text: "I couldn't live a week without a private library – indeed, I'd part with all my furniture and squat and sleep on the floor before I'd let go of the 1500 or so books I possess.",
  ...
  {
    text: "Luckily, I always travel with a book, just in case I have to wait on line for Santa, or some such inconvenience.",
  ...
  {
    text: "Somebody who only reads newspapers and at best books of contemporary authors looks to me like an extremely near-sighted person who scorns eyeglasses. He is completely dependent on the prejudices and fashions of his times, since he never gets to see or hear anything else.",
    author: "Albert Einstein"
  },
  {
    text: "I always read. You know how sharks have to keep swimming or they die? I'm like that. If I stop reading, I die.",
  ...
  {
    text: "I intend to put up with nothing that I can put down.",
  ...
  {
    text: "I took a speed-reading course and read War and Peace in twenty minutes. It involves Russia.",
    author: "Woody Allen"
  },
  {
  ...
  {
    text: "When I look back, I am so impressed again with the life-giving power of literature. If I were a young person today, trying to gain a sense of myself in the world, I would do that again by reading, just as I did when I was young.",
    author: "Maya Angelou"
  },
  {
  ...
  {
    text: "For my whole life, my favorite activity was reading. It's not the most social pastime.",
    author: "Audrey Hepburn"
  },
  {
    text: "Reading for me, is spending time with a friend.",
    author: "Gary Paulsen"
  },
  {
    text: "[F]rom the reading of 'good books' there comes a richness of life that can be obtained in no other way.",
    author: "Gordon B. Hinckley"
  },
  {
    text: "Fools have a habit of believing that everything written by a famous author is admirable. For my part I read only to please myself and like only what suits my taste.",
    author: "Voltaire"
  },
  {
  ...
  {
    text: "Reading is a basic tool in the living of a good life.",
    author: "Mortimer J. Adler"
  },
  {
  ...
  {
    text: "What better occupation, really, than to spend the evening at the fireside with a book, with the wind beating on the windows and the lamp burning bright.",
    author: "Gustave Flaubert"
  },
  {
    text: "I'm old-fashioned and think that reading books is the most glorious pastime that humankind has yet devised.",
    author: "Wisława Szymborska"
  },
  {
    text: "Never put off till tomorrow the book you can read today.",
  ...
  {
    text: "Of course anyone who truly loves books buys more of them than he or she can hope to read in one fleeting lifetime. A good book, resting unopened in its slot on a shelf, full of majestic potentiality, is the most comforting sort of intellectual wallpaper.",
    author: "David Quammen"
  },
  {
    text: "Reading should not be presented to children as a chore or a duty. It should be offered as a gift.",
...
export function getRandomQuote(): Quote {
  ...
  return BOOK_QUOTES[randomIndex];
}